...
const LoadingScreen = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-tr from-gray-50 to-gray-100">
      ...
      >
        <h1 className="text-3xl font-bold text-gray-800">NeuroSegment AI</h1>
        <h2 className="text-xl text-brand-600">Processing data</h2>
        
        <div className="relative pt-8">
          <div className="flex items-center justify-center pb-6">
            <motion.div 
              className="w-16 h-16 border-4 border-brand-200 border-t-brand-500 rounded-full animate-spin"
              animate={{ rotate: 360 }}
